  ...
  return (
    <div className='bg-white rounded-2xl border border-gray-100 shadow-sm p-6'>
      ...
      <div className='grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 border-t border-gray-100 pt-4'>
        <Button className="hover:bg-brand-light transition-colors w-full"><CheckCircle2 className="w-4 h-4" /> Move to Interview</Button>
        ...
        <Button variant="destructive" className="w-full font-bold hover:bg-red-700 transition-colors"><XCircle className="w-4 h-4" /> Reject</Button>
      </div>
    </div>
  );
}